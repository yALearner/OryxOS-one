 ...
 *
 * <p>12 个子命令：init / status / chat / serve / gateway /
 * profile list|create|show|delete / provider list / tool list / session list.
 *
 * <p>commands that require Spring Boot context (chat, serve, gateway)
 * start the full Spring container; others operate directly on files for fast startup.
 */
@Command(
        name = "oryxos",
